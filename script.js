...
const products = [
    ...
    {
        id: 5,
        name: 'Set Beige Minimalist',
        category: 'Bộ sưu tập',
        gender: 'Nữ',
        price: 899000,
        image: 'https://images.unsplash.com/photo-1759229874914-c1ffdb3ebd0c?w=600',
        rating: 5,
        colors: ['#F5E6D3', '#FFFFFF'],
        sizes: ['S', 'M', 'L'],
        badge: 'Mới'
    },
    {
    ...
    {
        id: 7,
        name: 'Áo Tank Top & Quần Jeans',
        category: 'Bộ sưu tập',
        gender: 'Nữ',
        price: 649000,
        salePrice: 519000,
        image: 'https://images.unsplash.com/photo-1762395271659-9465152c7e72?w=600',
        rating: 4.6,
        colors: ['#FFFFFF', '#000000'],
        sizes: ['S', 'M', 'L'],
        badge: 'Sale'
    ...
    {
        id: 8,
        name: 'Bộ Đen Thanh Lịch',
        category: 'Bộ sưu tập',
        gender: 'Nữ',
        price: 1099000,
        image: 'https://images.unsplash.com/photo-1765306552441-cd32bb216b0c?w=600',
        rating: 4.8,
        colors: ['#000000'],
        sizes: ['S', 'M', 'L'],
        badge: 'Mới'
    ...
    {
        id: 10,
        name: 'Tank Top & Jeans Set',
        category: 'Bộ sưu tập',
        gender: 'Nữ',
        price: 579000,
        image: 'https://images.unsplash.com/photo-1762395271662-2a5a077f9662?w=600',
        rating: 4.7,
        colors: ['#FFFFFF', '#000000', '#708090'],
        sizes: ['S', 'M', 'L'],
        badge: 'Mới'
    },
    {
...
// Categories Data
const categories = [
    { name: 'Áo thun', img: 'https://images.unsplash.com/photo-1630780565118-511258d74d08?w=400' },
    { name: 'Sơ mi', img: 'https://images.unsplash.com/photo-1630780564223-0aae7795126b?w=400' },
    { name: 'Quần', img: 'https://images.unsplash.com/photo-1593030761757-71fae45fa0e7?w=400' },
    { name: 'Váy', img: 'https://images.unsplash.com/photo-1770918655078-600f74bc53c5?w=400' },
    { name: 'Áo khoác', img: 'https://images.unsplash.com/photo-1615984259571-4d4d1084abbd?w=400' },
    { name: 'Phụ kiện', img: 'https://images.unsplash.com/photo-1761896902115-49793a359daf?w=400' }
];
        ...
        <div class="category-card" onclick="filterByCategory('${category.name}')">
            ...
            <div class="category-overlay">
                <div class="category-content">
                    ...
                    <button class="category-btn">Khám phá</button>
                </div>
            </div>
        </div>
    `).join('');
